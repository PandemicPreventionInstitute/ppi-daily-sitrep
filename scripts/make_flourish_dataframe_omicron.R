...
BNO_CASES_PATH<-'../data/raw/BNO_table.csv'

LAST_DATA_PULL_DATE<-as.Date("2021-12-01") # enter here "YYYY-10-18"
TIME_WINDOW <- 90
TIME_WINDOW_WEEK<- 6 
